...
import com.wechat.popular.bean.MessageSendResult;
import com.wechat.popular.bean.Uploadvideo;
import com.wechat.popular.bean.massmessage.MassMessage;
import com.wechat.popular.bean.message.Message;
