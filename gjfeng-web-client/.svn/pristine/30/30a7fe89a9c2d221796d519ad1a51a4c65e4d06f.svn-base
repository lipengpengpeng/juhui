                   ...
                   <li class="order-item">
                         ...
                         <div class="order-detail clearfix" >
                            ...
                            <div class="order-words left">
                                ...
                                <div class="order-info">
                                    ...
                                    <i class="order-money">¥ ${goods.goodsPrice}</i>
                                </div>
                            </div>
                         </div>
                         <%-- <input type="hidden" class="goodIds" value="${goods.goodsId}"/> --%>
                    ...
                    <div class="order-bottom clearfix">
                        ...
                        <c:if test="${list.orderStatus==2&&list.goodSoure!=3}">
                           <a onclick="confirmGood('${list.orderSn}',this)" class="pay-btn">确认收货</a>                                   
                        </c:if>
                        <c:if test="${list.orderStatus==2&&list.goodSoure==3}">
...
<div class="popup-box hidden">
            ...
            success:function(json){
                    ...
                    for(var j=0;j<json.result[i].goods.length;j++){
                         ...
                         +"<div class='order-words left'>"
                             ...
                             +"<div class='order-info'>"
                                ...
                                +"<i class='order-money'>¥ "+json.result[i].goods[j].goodsPrice+"</i>"
                             +"</div>"
                         +"</div>"
                     +"</div>"
                    }
                ...
                +"<div class='order-bottom clearfix'>"
                    ...
                    if(json.result[i].orderStatus==2&&json.result[i].goodSoure!=3){
                    	str+="<a onclick=confirmGood('"+json.result[i].orderSn+"',this) class='pay-btn'>确认收货</a>"
                    }
                    if(json.result[i].orderStatus==2&&json.result[i].goodSoure==3){
    ...
    //确认订单
    function confirmGood(orderNum,obj){ 
    	$(obj).attr("herf","javascript:return false;")
    	$(obj).attr("style","opacity: 0.2")
