...
<body>   
    <div class="container">
       <form class="set-form" id="set-form" > 
            ...
            <div class="form-item">
                <label for="" class="label-item"><i class="main-sprite lock-icon-mobile"></i></label>
                <input type="password" name="password" class="pwd-input" placeholder="请输入密码">
            </div>
            <div class="form-item">
                <label for="" class="label-item"><i class="main-sprite lock-icon-mobile"></i></label>
                <input type="password" name="pwd3" class="pwd-input" placeholder="请再次输入密码" id="pwd3">
            </div>
            <div class="form-item">
                <label for="" class="label-item"><i class="main-sprite lock-icon-mobile"></i></label>
                <input type="text" name="nickName" class="pwd-input " placeholder="请输昵称">
            </div>
