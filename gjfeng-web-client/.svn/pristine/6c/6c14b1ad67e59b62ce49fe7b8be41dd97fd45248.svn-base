    ...
    <div class="container">
        ...
        <div class="business-box">
            <div class="business-title clearfix">
                <div class="b-title-left left">${resultVo.result.storeName}</div>
            ...
            <ul class="business-list">
                ...
                <li class="business-li clearfix">
                    ...
                    <c:if test="${resultVo.result.storeStatus==0}">
                      <i class="" style="margin-left: -178px">店铺审核状态:</i>
                      <div class="left" style="margin-left: 100px;">
                        <span class="business-text" style="color:red;">店铺已经关闭</span>
                     </div>
                    </c:if>
                    <c:if test="${resultVo.result.storeStatus==1}">
                      <i class="" style="margin-left: -178px">店铺审核状态:</i>
                      <div class="left" style="margin-left: 100px;">
                        <span class="business-text" style="color:red;">审核通过</span>
                     </div>
                    </c:if>
                    <c:if test="${resultVo.result.storeStatus==2}">
                     <i class="" style="margin-left: -291px">店铺审核状态:</i>
                      <div class="left" style="margin-left: 100px;">
                        <span class="business-text" style="color:red;">店铺审核中请耐心等待审核通过</span>
                     </div>
                    </c:if>
                    <c:if test="${resultVo.result.storeStatus==3}">
                     <i class="" style="margin-left: -293px">店铺审核状态:</i>
                      <div class="left" style="margin-left: 100px;">
                        <span class="business-text" style="color:red;">店铺审核失败，请重新提交审核</span>
                     </div>
                    </c:if>
