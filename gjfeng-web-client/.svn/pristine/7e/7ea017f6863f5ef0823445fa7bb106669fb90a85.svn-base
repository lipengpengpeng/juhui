...
<body>
	...
	<c:if test="${not empty indexColumns.result}">
		...
		<!-- <div class="con-snacks com-bg">
			...
			<ul class="common-ul common-Img clearfix">
				<li class="lucky-item" style="float:left:;width: 50%">
					...
					<a onclick="goTianMao()">
						<img style="width: 90%;height: 1.5rem;" src="${imagePath}/wx/o2o-shop/微信图片_20171120095658.jpg">
					</a>
				</li>
				<li class="lucky-item" style="float:right;width: 50%">
					<a onclick="goTianMao()">
						<img style="width: 90%;height: 1.5rem;" src="${imagePath}/wx/o2o-shop/微信图片_20171120100226.jpg">
					</a>
				</li>
			</ul>
			...
			<ul class="common-ul common-Img clearfix" style="margin-top: 15px">
				<li class="lucky-item" style="width: 50%;float:left">
					<a href="">
						<img style="width: 90%;height: 1.5rem;" src="${imagePath}/wx/o2o-shop/微信图片_20171117172544.jpg">
					</a>
				</li>
				<li class="lucky-item" style="width: 50%;float:right;">
					<a href="${ctx}/wx/product/goJDProductListPage">
						<img style="width: 90%;height: 1.5rem;" src="${imagePath}/wx/o2o-shop/微信图片_20171226135827.png">
					</a>
				</li>
			</ul>
		...
		<div class="con-snacks com-bg" style="margin-top: 0.1rem;padding: 0;width: 100%;">
