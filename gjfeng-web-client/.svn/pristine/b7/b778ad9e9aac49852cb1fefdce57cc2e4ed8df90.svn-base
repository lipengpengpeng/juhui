package com.wechat.popular.util;
...
import com.wechat.popular.bean.pay.PayNativeReply;
import com.wechat.popular.bean.pay.PayNativeRequest;
import com.wechat.popular.bean.pay.PayPackage;
import com.wechat.popular.bean.paymch.MchPayNativeReply;
...
public class PayUtil {
	 ...
	 * @return
	 */
	public static PayJsRequest generateMchPayJsRequestJson(String prepay_id,String appId,String key){
