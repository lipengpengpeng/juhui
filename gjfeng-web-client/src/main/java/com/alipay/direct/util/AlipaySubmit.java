...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
		...
		String mysign = "";
		if (AlipayConfig.sign_type_web.equals("RSA2")) {
			//mysign = MD5.sign(prestr, AlipayConfig.RSA_PRIVATE,
					//AlipayConfig.input_charset);
			mysign=SignUtils.sign(prestr,AlipayConfig.RSA_PRIVATE);
		}
		return mysign;
	}
	 ...
	 * @return
	 */
	public static Map<String, String> getParams(String orderSn,String totalMoney,String notify_url,String return_url) {		
		Map<String, String> params = new HashMap<String, String>();
		params.put("service", AlipayConfig.alipay_services_inweb);
		...
		params.put("subject", "用户下单购买商品");
		DecimalFormat    df   = new DecimalFormat("######0.00");
		params.put("total_fee", totalMoney.toString());// order.getPrice().toString()
