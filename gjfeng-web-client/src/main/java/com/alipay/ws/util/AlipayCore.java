...
import com.alipay.ws.config.AlipayConfig;
...
public class AlipayCore {
    ...
    public static void main(String[] args) {
		//String bodyStr = ";11;22;33;44";
		String bodyStr = ";mm;352166053492552;;";
		String body = "";
		String channel_id = "";
		String divice_id = "";
		String member_id = "";
		...
		member_id = bodyStr.substring(0, bodyStr.indexOf(";"));
		
		pass_id = bodyStr.substring(bodyStr.lastIndexOf(";")+1, bodyStr.length());
		
		/*String[] bodyArray = bodyStr.split(";");
		if(bodyArray.length == 5) {
			body = bodyArray[0];
			channel_id = bodyArray[1];
			divice_id = bodyArray[2];
			member_id = bodyArray[3];
			pass_id = bodyArray[4];
		}*/
