			...
			<div class="wallet-tab-box" id="wallet-1-1">
				<div class="wallet-branch-2 clearfix agent-top-box">
					<div class="w2-left left">
						...
						<div class="w2-num">${resultVo.result.opcenterTotalMoney}</div>
					</div>
					<div class="w2-right left">
						<p class="w2-text">待派发收入</p>
						<div class="w2-money">${resultVo.result.opcenterMoney}</div>
					</div>
				</div>
			</div>
		</div>
		<div class="wallet-tab-box" id="wallet-1-2">
			<div class="wallet-middle clearfix">
				<div class="wm-item left agent-item">
					...
					<div class="wm-money">${resultVo.result.mchBenefit}</div>
				</div>
				<div class="wm-item left agent-item">
					<p class="wm-text">商家总让利</p>
					<div class="wm-money">${resultVo.result.mchTotalBenefit}</div>
				</div>
			</div>
		</div>
		<div class="wallet-menu clearfix">
			<a href="${ctx}/wx/member/opcenterMchInfo?pageNo=1&pageSize=20&memId=${resultVo.result.id}" class="wmenu-item left agent-item">
				<div class="wmenu-img">
					<img src="${ctx}/common/image/wx/o2o-shop/wallet_history.png">
				</div>
				<div class="wmenu-text">商家列表</div>
			</a>
			<a href="${ctx}/wx/member/opcenterHistory?memId=${resultVo.result.id}" class="wmenu-item left agent-item">
				<div class="wmenu-img">
					<img src="${ctx}/common/image/wx/o2o-shop/wallet_history.png">
				</div>
