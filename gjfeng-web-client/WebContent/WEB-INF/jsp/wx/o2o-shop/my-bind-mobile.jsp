...
<body>   
    <div class="container">
       <form class="set-form" id="set-form" > 
            ...
            <div class="form-item">
                <label for="" class="label-item"><i class="main-sprite lock-icon-mobile"></i></label>
                <input type="password" name="password" class="pwd-input" placeholder="请输入登录密码" id="pwd-2">
            </div>
            <div class="form-codeItem clearfix">
             ...
             <div style="padding-bottom: 20px">
                <input type="checkbox" name="memService" style="margin-left: 25px;box-shadow: none;margin-top: 20px;"><a href="${ctx}/wx/rule/memService" style="margin-left:6px;font-size:13px">《巨惠云商o2o用户注册协议》</a>
             </div>                
