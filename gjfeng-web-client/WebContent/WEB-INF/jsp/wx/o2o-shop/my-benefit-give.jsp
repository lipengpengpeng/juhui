...
<body>
    <div class="container">
        <form class="buy-bonus-form" action="">
            <input name="merchantGrade" type="hidden" value="1" id="merchantGrade"/>
            ...
            <div class="grade">
                <div class="mergrade clearfix type1" data-Value='1' style="border:1px solid #5ac715">
                  <label class="gradeLabel" >一类</label>                 
                </div>
                <div class="mergrade clearfix type2" data-Value='2' >
                    <label class="gradeLabel" >二类</label>                 
                 </div>
                 <div class="mergrade clearfix type3" data-Value='3' >
                     <label class="gradeLabel" >三类</label>                 
                 </div>
            </div>
            ...
            <div class="btn-box">
                <button type="button" class="btn" id="saveToPay">确认录入</button>
            </div>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $(".mergrade").each(function(){
            	$(this).click(function(){
            		var dataValue=$(this).attr("data-Value"); 
            		var status=$(".icon-circle-active").parent().parent().attr("data-id");
            		if(status==undefined){
            			status=-1
            		}
            		
            		var bonusNum = $("#bonus-num").val()
            		if(dataValue==1){
            			...
            			if(status==4){
            				...
            				$(".bonusPay-money").text((bonusNum*0.15).toFixed(2));
            			}
            		}else{
            			$(".type1").css({border:"1px solid #555"});
            			$(".type2").css({border:"1px solid #555"});
            			...
            			if(status==4){
            				...
            				$(".bonusPay-money").text((bonusNum*0.2).toFixed(2));
            			}
            		}
            	})
            })
                ...
                yes: function(index){//点击去认证页面，index为该特定层的索引
                	$.ajax({
        	            ...
        	            data: {
        	            	...
        	            	"payType":payType,
        	            	 "merchantGrade":$("#merchantGrade").val()
        	            	},
                        				    ...
                        				    success: function (res) {
                        				    	...
                        				    	if(res.errMsg == "chooseWXPay:ok" ) {
                           				    	 layer.open({
                           				                ...
                           				                btn: ['我知道了'],
                           				                yes: function(index){//点击去认证页面，index为该特定层的索引                  				                	
                           				                	window.location.href="${ctx}/wx/trade/benefits"
                           				                    layer.close(index);
                           				                }                   				               
                           				           });	                       				     
                           				        } 
        ...
        function actMoney(status){
            ...
            if(bonusNum != "" && bonusNum != undefined && reg.test(bonusNum) && intBonus!=0){
            	//获取类型
            	var gradeType=$("#merchantGrade").val()          	
            	if(status=='4'){
            		$(".bonusPay-money").text(bonusNum);
            	}else{
            		if(gradeType==1){
