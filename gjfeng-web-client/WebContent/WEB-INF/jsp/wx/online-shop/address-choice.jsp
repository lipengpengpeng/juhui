...
<body>
	     ...
	     <c:if test="${address.isDefault==1}">
			...
			<li>
				<div class="add-choice-ad">
					<a href="${ctx}/wx/address/toUpdate?id=${address.id}&goodSource=${goodSource}" class="add-choice-alter"></a>
	...
	<footer class="address-choicefooter">
		<a href="${ctx}/wx/address/goNewsAddress?type=${type}&goodSource=${goodSource}" class="address-adda">+添加新地址</a>
	</footer>
