...
<body>
	...
	function goProductDetail(proId){
		window.location.href="http://aihua.likecs.com/index.php?mod=aihua&act=fenghuang&param=detail&id="+proId+"&userid="+uid+"&phone="+mobile+"&email=&kh=fenghuang&tbnum="
	}
	 ...
	 function ajaxLoad(page){
		...
		$.ajax({
			url:"${ctx}/wx/product/findProductList",
		    method:"get",
		    data:{
		    	type:type,
		    	page:page
		    ...
		    success:function(data){
		    	...
		    	for(var i=0;i<data.length;i++){
		    		str+="<li class='product-item'><a href='http://aihua.likecs.com/index.php?mod=aihua&act=fenghuang&param=detail&id="+data[i].id+"&userid="+uid+"&phone="+mobile+"&email=&kh=fenghuang&tbnum='><div class='product-img'>"
						 +"<img src='"+data[i].smallPic+"' alt=''></div>"
	 ...
	 function ajaxSerchLoad(page){
		 $.ajax({
				url:"${ctx}/wx/product/findProductListBySerch",
				method:"get",
				data:{
					keyWord:$("#keyWord").val(),
					page:page
