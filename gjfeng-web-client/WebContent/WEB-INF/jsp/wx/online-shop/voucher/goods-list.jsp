   ...
   <div class="form-wrapper cf">
					...
					<div class="foods-font">
						...
						<c:if test="${bean.isCanUserCou==0 }">
						  <c:if test="${merchantType==1}">
						      <p class="foods-money"><fmt:formatNumber value="${bean.price}" pattern="0"/></p>
	...
	$(function(){
		...
		function loading(){
			...
			//上拉刷新
			 function Refresh() {
				...
				ajaxLoad(1,pageSize,0);
			} 
			//加载更多
			 
			function Load() {
               
				ajaxLoad($("#wrapper").attr("pageNo"),pageSize,1);
			}
		}loading();
		...
		$(".foods-reg").fonts({
	     ...
	     function ajaxLoad(pageNo,pageSize,refreshType){
	      
	       $.ajax({
	           url: '${ctx}/wx/trade/getVouchersByPage',
	           type: 'get',
	           dataType: 'html',
	           data: {
	           	"pageNo":pageNo,
	           	"pageSize":pageSize,
	           	"likeName":$("#searchInput").val(),
	           	type:""
	           	},
