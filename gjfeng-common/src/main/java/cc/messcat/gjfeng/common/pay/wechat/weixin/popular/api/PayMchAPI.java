...
import cc.messcat.gjfeng.common.pay.wechat.weixin.popular.api.BaseAPI;
import cc.messcat.gjfeng.common.pay.wechat.weixin.popular.bean.paymch.Closeorder;
import cc.messcat.gjfeng.common.pay.wechat.weixin.popular.bean.paymch.MchBaseResult;
import cc.messcat.gjfeng.common.pay.wechat.weixin.popular.bean.paymch.MchShorturl;
import cc.messcat.gjfeng.common.pay.wechat.weixin.popular.bean.paymch.MchShorturlResult;
import cc.messcat.gjfeng.common.pay.wechat.weixin.popular.bean.paymch.Refundquery;
import cc.messcat.gjfeng.common.pay.wechat.weixin.popular.bean.paymch.RefundqueryResult;
...
import cc.messcat.gjfeng.common.pay.wechat.weixin.popular.bean.paymch.Unifiedorder;
import cc.messcat.gjfeng.common.pay.wechat.weixin.popular.bean.paymch.UnifiedorderResult;
...
//		SecapiPayRefundResult refund = new SecapiPayRefundResult();
//		refund.setAppid("wxd930ea5d5a258f4f");
//		refund.setMch_id("10000100");
//		refund.setNonce_str("ibuaiVcKdpRxkhJA");
//		refund.setDevice_info("1000");
//		Map<String,String> map = MapUtil.objectToMap(refund);
		...
		String sign = SignatureUtil.generateSign(map,"123456");
