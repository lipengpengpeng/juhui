...
import cc.messcat.gjfeng.common.pay.wechat.weixin.popular.api.TicketAPI;
	...
	public static void init(final String appid) throws InterruptedException {
		...
		timer.schedule(new TimerTask() {
			...
			public void run() {
				...
				do {
					try {
						...
						if (ObjValid.isValid(access_token)) {
							...
							log.error("TicketManager类----init方法-----拿取token失败");
						}
				...
				log.error("TicketManager类----init方法-----获取ticket:" + ticket.getTicket());
			}
