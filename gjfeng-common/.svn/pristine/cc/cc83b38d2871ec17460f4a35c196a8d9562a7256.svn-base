package cc.messcat.gjfeng.common.wechat.popular.bean;
...
public class User extends BaseResult{
	...
	public String toString() {
		return "User [city=" + city + ", country=" + country + ", headimgurl="
				+ headimgurl + ", language=" + language + ", nickname="
				+ nickname + ", openid=" + openid + ", privilege="
				+ Arrays.toString(privilege) + ", province=" + province
				+ ", sex=" + sex + ", subscribe=" + subscribe
