...
import cc.messcat.gjfeng.common.jd.Signatures;
...
public class HttpUtils {
	...
	public static String getData(String url, String requestPath, Map<String, Object> data,String param) {
		...
		try {
			...
			IOUtils.copy(new ByteArrayInputStream(param.getBytes("utf-8")), out, "utf-8");
			out.flush();
