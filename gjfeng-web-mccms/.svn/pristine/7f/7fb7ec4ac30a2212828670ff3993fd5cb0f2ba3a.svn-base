...
public class ExcelHandler {
	...
	public static Object getValueByClassType(String classType, String value) throws Exception {
		...
		if (StringUtil.isBlank(value) || "null".equals(value)) {
			...
			if ("int".equals(classType) || "java.lang.Integer".equals(classType)) {
				...
				try {
					if (value.length() == 10) {
						reValue = ExcelHandler.stringToDate(value, "yyyy-MM-dd");
					} else if (value.length() == 19) {
						reValue = ExcelHandler.stringToDate(value, "yyyy-MM-dd HH:mm:ss");
					}
				} catch (Exception e) {
	...
	private static Date stringToDate(String strDate, String format) throws Exception {
