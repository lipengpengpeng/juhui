...
function showArea(){
	...
	var iptLeft=iptOffSet.left+100;
	var iptTop=iptOffSet.top-80;
	var str="<div id='addr'><iframe style='position:absolute;width:100%; z-index:-1;' frameborder='0' src='about:blank'></iframe><span>请选择地点<a id='fh'>返回省份列表</a><a id='gb'>[&nbsp;关闭&nbsp;]</a></span><ul></ul><div style='clear:both;'></div></div>";
