...
public class EnterpriseColumn implements Serializable {
	 ...
	 * 产品-栏目
	 * */
	//private Set<ProductColumn> productList = new HashSet<ProductColumn>();
	...
	/*public Set<ProductColumn> getProductList() {
		return productList;
	}
	
	public void setProductList(Set<ProductColumn> productList) {
