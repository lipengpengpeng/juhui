	...
	<form action="memberInfoAction!updateToAgent.action" method="post" id="agentForm" name="agentForm" onsubmit="return check()">
		...
		<table align="center" class="listTable3">
				<tr>
					...
					<td>
						个代：<input id="indiAgent" name="type" type="radio" value="1" checked="checked" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						区代：<input id="areaAgent" name="type" type="radio" value="2" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						市代：<input id="cityAgent" name="type" type="radio" value="3" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
