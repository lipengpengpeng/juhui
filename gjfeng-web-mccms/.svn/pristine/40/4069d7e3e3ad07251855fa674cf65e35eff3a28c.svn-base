	...
	<table class="listTable2">
			<tr>
				...
				<td width="90%">
					...
					<!-- 添加模板信息 --><s:text name="enterprise.style.current.location.template.add" />
				</td>
				<td>
 	 ...
 	 <table class="listTable3" onmouseover="changeto()"  onmouseout="changeback()">
			<tr>
				<td><!-- 模板名称 --><s:text name="enterprise.style.template.name" /></td><td><input type="text" name="names"  size="60" /></td>
			</tr>
			<tr>
				<td><!-- 模板文件夹名称 --><s:text name="enterprise.style.template.folder.name" /></td><td><input type="text" name="filename"  size="60" /></td>
			</tr>
			<tr>
