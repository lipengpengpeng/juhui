...
(function($){
	...
	$.fn.supersized = function() {
		...
		$("<img/>").attr("src", options.slides[options.slides.length - 1].image).appendTo("#supersized").wrap("<a style='cursor:default'" + imageLink + "></a>");//Doesnt account for start slide
		
		//Set current image
		imageLink = (options.slides[$.currentSlide].url) ? "href='" + options.slides[$.currentSlide].url + "'" : "";
		$("<img/>").attr("src", options.slides[$.currentSlide].image).appendTo("#supersized").wrap("<a style='cursor:default class=\"activeslide\" " + imageLink + "></a>");
		
		//Set next image
		imageLink = (options.slides[$.currentSlide + 1].url) ? "href='" + options.slides[$.currentSlide + 1].url + "'" : "";
		$("<img/>").attr("src", options.slides[$.currentSlide + 1].image).appendTo("#supersized").wrap("<a style='cursor:default " + imageLink + "></a>");
	...
	function nextslide() {
		...
		$("<img/>").attr("src", options.slides[loadSlide].image).appendTo("#supersized").wrap("<a style='cursor: default'" + imageLink + "></a>");
	...
	function prevslide() {
		...
		imageLink = (options.slides[loadSlide].url) ? "href='" + options.slides[loadSlide].url + "'" : "";
		$("<img/>").attr("src", options.slides[loadSlide].image).prependTo("#supersized").wrap("<a style='cursor: default' " + imageLink + "></a>");
