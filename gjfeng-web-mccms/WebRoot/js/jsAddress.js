...
//defaultProvince  : 默认的省
//defaultCity	   : 默认的地区
//返回一个selareaList
  //defaultProvince  : 默认的省
//defaultCity	   : 默认的地区
//返回一个selareaList
function getCounty( defaultProvince, defaultCity){
	...
	for(var i=0; i<provinceList.length; i++)
	{
		...
		if(provinceList[i].name==defaultProvince){
			...
			selcityList=provinceList[i].cityList;
		}

	}
	
	for(var i=0; i<selcityList.length; i++)
	{

		if(selcityList[i].name==defaultCity){
			selareaList=selcityList[i].areaList;
		}
	}
...
{name:'广东', cityList:[		   
{name:'广州', areaList:['市辖区','荔湾区','越秀区','海珠区','天河区','白云区','黄埔区','番禺区','南沙区','花都区','萝岗区','增城市','从化市']},	
...
{name:'湛江', areaList:['经济技术开发区','赤坎区','霞山区','坡头区','麻章区','遂溪县','徐闻县','廉江市','雷州市','吴川市']},	
{name:'肇庆', areaList:['高新区','端州区','鼎湖区','广宁县','怀集县','封开县','德庆县','高要市','四会市']},	
{name:'江门', areaList:['市辖区','蓬江区','江海区','新会区','台山市','开平市','鹤山市','恩平市']},	
{name:'茂名', areaList:['市辖区','茂南区','茂港区','电白县','高州市','化州市','信宜市','高新区']},	
{name:'惠州', areaList:['市辖区','惠城区','惠阳区','博罗县','惠东县','龙门县']},	
{name:'梅州', areaList:['市辖区','梅江区','梅　县','大埔县','丰顺县','五华县','平远县','蕉岭县','兴宁市']},	
{name:'汕尾', areaList:['市辖区','城　区','海丰县','陆河县','陆丰市','华侨管理区','红海湾经济开发区']},
{name:'河源', areaList:['市辖区','源城区','紫金县','龙川县','连平县','和平县','东源县']},	
{name:'阳江', areaList:['市辖区','江城区','阳西县','阳东县','阳春市','高新区','海陵区']},	
{name:'清远', areaList:['市辖区','清城区','佛冈县','阳山县','连山壮族瑶族自治县','连南瑶族自治县','清新县','英德市','连州市']},	
{name:'东莞', areaList:['莞城区','南城区','万江区','东城区','石碣镇','石龙镇','茶山镇','石排镇','企石镇','横沥镇','桥头镇','谢岗镇','东坑镇','常平镇','寮步镇','大朗镇','黄江镇','清溪镇','塘厦镇','凤岗镇','长安镇','虎门镇','厚街镇','沙田镇','道窖镇','洪梅镇','麻涌镇','中堂镇','高埗镇','樟木头镇','大岭山镇','望牛墩镇','松山湖高新区','虎门港','生态产业园']},	
{name:'中山', areaList:['东区','石岐区','火炬区','南区','西区','五桂山镇','黄圃镇','南头镇','东凤镇','阜沙镇','小榄镇','东升镇','古镇镇','横栏镇','三角镇','民众镇','南朗镇','港口镇','大涌镇','沙溪镇','三乡镇','板芙镇','神湾镇','坦洲镇']},	
{name:'潮州', areaList:['市辖区','湘桥区','潮安县','饶平县']},	
{name:'揭阳', areaList:['市辖区','榕城区','揭东县','揭西县','惠来县','普宁市']},	
{name:'云浮', areaList:['市辖区','云城区','新兴县','郁南县','云安县','罗定市']},	
{name:'顺德', areaList:['大良','勒流','伦教','容桂','陈村','均安','杏坛','龙江','乐从','北滘']}
]},
{name:'广西', cityList:[		   
