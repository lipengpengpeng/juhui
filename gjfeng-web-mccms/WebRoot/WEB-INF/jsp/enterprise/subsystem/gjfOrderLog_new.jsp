...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="gjfOrderLogAction!newGjfOrderLog.action" method="post" id="gjfOrderLogForm" name="gjfOrderLogForm" enctype="multipart/form-data">
			<table  align="center" class="listTable3">
				<tr>
					<td class="pn-flabel" width="100px">FK:订单id</td>
					<td><input type="text" id="orderId" name="gjfOrderLog.orderId" /></td>
				</tr>
				<tr>
					<td class="pn-flabel" width="100px">文字描述</td>
					<td><input type="text" id="logMsg" name="gjfOrderLog.logMsg" /></td>
				</tr>
				<tr>
					<td class="pn-flabel" width="100px">处理时间</td>
					<td><input type="text" id="logTime" name="gjfOrderLog.logTime" /></td>
				</tr>
				<tr>
					<td class="pn-flabel" width="100px">操作角色</td>
					<td><input type="text" id="logRole" name="gjfOrderLog.logRole" /></td>
				</tr>
				<tr>
					<td class="pn-flabel" width="100px">操作人</td>
					<td><input type="text" id="logUserName" name="gjfOrderLog.logUserName" /></td>
				</tr>
				<tr>
					<td class="pn-flabel" width="100px">订单状态（0:未付款 1:已付款 2:已发货 3:已收货 4:已过期 5:已取消 6:已退款）</td>
					<td><input type="text" id="logOrderStatus" name="gjfOrderLog.logOrderStatus" /></td>
				</tr>
