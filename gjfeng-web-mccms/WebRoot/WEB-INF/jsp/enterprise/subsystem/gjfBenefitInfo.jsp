		...
		<form action="" method="post" id="gjfBenefitInfoForm" name="gjfBenefitInfoForm" >
			<table  align="center" class="listTable3" >
				...
				<tr>
					...
					<c:if test="${bean.ratioType eq '0'}">
						<td><input type="text" size="5" id="issueRatio" name="gjfBenefitInfos[${status.count-1}].directMembersSecondRatio" value="<fmt:formatNumber value='${bean.directMembersSecondRatio}' pattern='##.#####'></fmt:formatNumber>" /></td>
					    <td><input type="text" size="5" id="issueRatio" name="gjfBenefitInfos[${status.count-1}].directMembersThreeRatio" value="<fmt:formatNumber value='${bean.directMembersThreeRatio}' pattern='##.#####'></fmt:formatNumber>" /></td>
					    <td><input type="text" size="5" id="issueRatio" name="gjfBenefitInfos[${status.count-1}].directMerchantsSecondRatio" value="<fmt:formatNumber value='${bean.directMerchantsSecondRatio}' pattern='##.#####'></fmt:formatNumber>" /></td>
					    <td><input type="text" size="5" id="issueRatio" name="gjfBenefitInfos[${status.count-1}].directMerchantsThreeRatio" value="<fmt:formatNumber value='${bean.directMerchantsThreeRatio}' pattern='##.#####'></fmt:formatNumber>" /></td>
					    <td><input type="text" size="5" id="issueRatio" name="gjfBenefitInfos[${status.count-1}].operationCenterRatio" value="<fmt:formatNumber value='${bean.operationCenterRatio}' pattern='##.#####'></fmt:formatNumber>" /></td>
					</c:if>
					<c:if test="${bean.ratioType eq '1'}">
						<td></td>
					    <td></td>
