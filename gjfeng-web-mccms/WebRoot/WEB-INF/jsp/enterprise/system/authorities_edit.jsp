...
$(document).ready(function(){
	...
	<body style="padding:8px;">
		...
		<div class="rhead">
			<div class="rpos">
				...
				<!-- 编辑权限信息 --><s:text name="enterprise.system.authority.current.location.edit" />
			</div>
	...
	  	</div>
		...
		<table  align="center" class="listTable3" width="90%">
			<tr>
				<td><!-- 父级权限 --><s:text name="enterprise.system.authority.father.level" /></td>
				<td>
					<input type="text" name="fatherAuthName" id="fatherAuthName" value="${fatherAuthName}" onfocus="listAuthorities();" readonly/>
				</td>
			</tr>
			<tr>
				<td><!-- 权限名称 --><s:text name="enterprise.system.authority.name" /></td>
				<td>
					<input type="text" name="name" value="${authorities.name}"/>
				</td>
			</tr>
			<tr>
				<td><!-- 显示名称 --><s:text name="enterprise.system.authority.display.name" /></td>
				<td>
			...
			<tr>
				...
				<td>
					<select name="authorities.authoritiesType" id="authoritiesType">
						<option value="1"><!-- 栏目 --><s:text name="enterprise.system.authority.column" /></option>
