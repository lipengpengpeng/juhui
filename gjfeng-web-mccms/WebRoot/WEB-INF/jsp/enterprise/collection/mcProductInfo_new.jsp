		 ...
		 $(document).ready(function(){
			$("#mcProductInfoForm").validate({
					rules: {
						...
						"gjfProductInfo.standardPrice": {
							required : true,
							number : true,
							min : 0,
							maxlength : 10,
						},
						"gjfProductInfo.honourPrice": {
							required : true,
							number : true,
							min : 0,
							maxlength : 10,
	...
	<body>
		...
		<form action="mcProductInfoAction!newMcProductInfo.action" method="post" id="mcProductInfoForm" name="mcProductInfoForm" enctype="multipart/form-data">
			<table  align="center" class="listTable3">
				...
				<tr>
					<td class="pn-flabel" width="100px"><i style="color:red"> * </i>标准版金额</td>
					<td>
						<input type="text" name="gjfProductInfo.standardPrice"/>
					</td>
				</tr>
				<tr>
					<td class="pn-flabel" width="100px"><i style="color:red"> * </i>尊享版金额</td>
					<td>
						<input type="text" name="gjfProductInfo.honourPrice"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="pn-flabel" width="100px"><i style="color:red"> </i>销售数量</td>
					<td>
						<input type="text" name="gjfProductInfo.salesNum" value="99"/>
					</td>
				</tr>
				<tr>
					<td class="pn-flabel" width="100px"><i style="color:red"> </i>商品参与让利金额 </td>
					<td>
						<input type="text" name="gjfProductInfo.benerfitMoney"/>
					</td>
				</tr>
				<tr>
					<td class="pn-flabel" width="100px"><i style="color:red"> </i>采购倍数 </td>
					<td>
						<input type="text" name="gjfProductInfo.multipleNumber" value="1"/>
					</td>
				</tr>
				<tr>
					<td class="pn-flabel" width="100px"><i style="color:red"> </i>直推奖励金额 </td>
					<td>
						<input type="text" name="gjfProductInfo.derectMemberVor" value="0"/>
					</td>
				</tr>
				<tr>
					<td class="pn-flabel" width="100px"><i style="color:red"> </i>第二级推荐人奖励 </td>
					<td>
						<input type="text" name="gjfProductInfo.firstDerectMemberVor" value="0"/>
					</td>
				</tr>
		...
		<script type="text/javascript">
				...
				function joinTable2(element){
					num++;
					var str3 = "<tr>";
					var str4 = '<th class="goods-th pn-flabel">价格（必需填写）</th><th class="goods-th pn-flabel">标准版价格（必需填写）</th><th class="goods-th pn-flabel">尊享版价格（必需填写）</th><th class="goods-th pn-flabel">库存（必需填写）</th><th class="goods-th pn-flabel">操作</th></tr>';
					var str5 = ''; 
					var str6 = '<td class="goods-td pn-flabel"><input type="text" name="arrts['+i+'].price" value="" class="{required:true,number:true,min:0}"></td>'+
					'<td class="goods-td pn-flabel"><input type="text" name="arrts['+i+'].standardPrice" value="" class="{required:true,number:true,min:0}"></td>'+
					'<td class="goods-td pn-flabel"><input type="text" name="arrts['+i+'].honourPrice" value="" class="{required:true,number:true,min:0}"></td>'+
