...
public class McProductInfoAction extends PageAction {
	...
	private  GjfSupplierInfo supplierInfo;
	 ...
	 * @return
	 */
	public String findSupplierInfo(){
		try{
			resultVo =productInfoDubbo.findSupplierInfoByPage(pageNo, pageSize, mobile);
		}catch(Exception e){
			e.printStackTrace();
		}
		return "all_supplier";
	 ...
	 * 跳转到新增供应商列表页面
	 */
	public String toNewSupplierPage(){
		try{
			resultVo =productInfoDubbo.addSupplierInfo(supplierInfo);
		}catch(Exception e){
			e.printStackTrace();
		}
	 ...
	 * @return
	 */
	public String newSupplierInfo(){
		try{
			resultVo =productInfoDubbo.addSupplierInfo(supplierInfo);
		}catch(Exception e){
			e.printStackTrace();
		}
		return findSupplierInfo();
	}
	/**
	 * 跳转到编辑页面
	 * @return
	 */
	public String toUpateSupplierPage(){
		try{
			
		}catch(Exception e){
			e.printStackTrace();
		}
		return "update_supplier_page";
	}
	...
	public String updateSupplierInfo(){
		try{
			resultVo=productInfoDubbo.updateSupplierInfo(supplierInfo);
		}catch(Exception e){
			e.printStackTrace();
		}
		return findSupplierInfo();
	...
	public GjfSupplierInfo getSupplierInfo() {
		return supplierInfo;
	}

	public void setSupplierInfo(GjfSupplierInfo supplierInfo) {
