...
public class CountInfoDubboImpl implements CountInfoDubbo {
	...
	public ResultVo addTotalReportData(Integer pageNo, Integer pageSize, String beginTime, String endTime) {
		...
		return countInfoService.addAccountDataByTime(pageNo, pageSize, beginTime, endTime);
	}
	...
	public ResultVo updateCouneInf(Long id) {
		...
		return countInfoService.updateCountInfo(id);
	}
	...
	public ResultVo addTotalReport(String addTime) {	
		return countInfoService.addTotalReportByTime(addTime);
	}
	...
	public ResultVo modifyAcountConsumption() {
		...
		return gjfBenefitInfoService.modifyMemberDiviByMonth();
	}
	...
	public ResultVo modifyMemberDeductDivi() {
		...
		return gjfBenefitInfoService.modifyMemberDeductDivi();
	}
	...
	public ResultVo modifyMemberIsActivity() {
		...
		return countInfoService.updateMemberIsActivity();
	}
