...
public class GjfBenefitPool implements java.io.Serializable {
	...
	@Column(name = "MEMBER_SYS_POOL_CUR_", precision=10, scale=2)
	private BigDecimal memberSysPoolCur;
	
	@Column(name = "MERCHANT_SYS_POOL_CUR_", precision=10, scale=2)
	private BigDecimal merchantSysPoolCur;
	
	@Column(name = "PLATFORM_SYS_POOL_CUR_", precision=10, scale=2)
	private BigDecimal platformSysPoolCur;
	
	@Column(name = "DIRECT_MEMBER_SYS_POOL_CUR_", precision=10, scale=2)
	private BigDecimal directMemberSysPoolCur;
	
	@Column(name = "DIRECT_MERCHANTS_SYS_POOL_CUR_", precision=10, scale=2)
	private BigDecimal directMerchantsSysPoolCur;
	
	@Column(name = "AGENT_SYS_POOL_CUR_", precision=10, scale=2)
	private BigDecimal agentSysPoolCur;
	
	@Column(name = "AGENT_SYS_CITY_POOL_CUR_", precision=10, scale=2)
	private BigDecimal agentSysCityPoolCur;
	
	@Column(name = "AGENT_SYS_AREA_POOL_CUR_", precision=10, scale=2)
	private BigDecimal agentSysAreaPoolCur;
	
	@Column(name = "AGENT_SYS_INDI_POOL_CUR_", precision=10, scale=2)
	private BigDecimal agentSysIndiPoolCur;
	
	@Column(name = "MEMBER_SYS_POOL_TOTAL_", precision=10, scale=2)
	private BigDecimal memberSysPoolTotal;
	
	@Column(name = "MERCHANT_SYS_POOL_TOTAL_", precision=10, scale=2)
	private BigDecimal merchantSysPoolTotal;
	
	@Column(name = "PLATFORM_SYS_POOL_TOTAL_", precision=10, scale=2)
	private BigDecimal platformSysPoolTotal;
	
	@Column(name = "DIRECT_MEMBER_SYS_POOL_TOTAL_", precision=10, scale=2)
	private BigDecimal directMemberSysPoolTotal;
	
	@Column(name = "DIRECT_MERCHANTS_SYS_POOL_TOTAL_", precision=10, scale=2)
	private BigDecimal directMerchantsSysPoolTotal;
	
	@Column(name = "AGENT_SYS_POOL_TOTAL_", precision=10, scale=2)
	private BigDecimal agentSysPoolTotal;
	
	@Column(name = "AGENT_SYS_CITY_POOL_TOTAL_", precision=10, scale=2)
	private BigDecimal agentSysCityPoolTotal;
	
	@Column(name = "AGENT_SYS_AREA_POOL_TOTAL_", precision=10, scale=2)
	private BigDecimal agentSysAreaPoolTotal;
	
	@Column(name = "AGENT_SYS_INDI_POOL_TOTAL_", precision=10, scale=2)
	private BigDecimal agentSysIndiPoolTotal;
	
	@Column(name = "TOKEN_", length = 200)
	private String token;
	
	@Column(name = "OPCENTER_POOL_INCOM_", precision=10, scale=2)
	private BigDecimal opcenterPoolInCom;
	
	@Column(name = "OPCENTER_POOL_SPEND_", precision=10, scale=2)
	private BigDecimal opcenterPoolSpend;
	
	@Column(name = "MERCHART_FIRST_GRADE_", precision=20, scale=2)
	private BigDecimal merchartFirstGrade;
	
	@Column(name = "MERCHART_SECOND_GRADE_", precision=20, scale=2)
	private BigDecimal merchartSecondGrade;
	
	@Column(name = "MERCHART_THREE_GRADE_", precision=20, scale=2)
