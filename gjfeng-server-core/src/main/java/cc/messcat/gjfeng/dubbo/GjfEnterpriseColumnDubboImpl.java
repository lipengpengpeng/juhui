...
public class GjfEnterpriseColumnDubboImpl implements GjfEnterpriseColumnDubbo {
	...
	public ResultVo findProductModelColumn(String frontNum,String isValidInNav) {
		...
		return gjfEnterpriseColumnService.findProductModelColumn(frontNum,isValidInNav);
	}
	...
	public ResultVo findEnterpriseNewsList(Integer pageNo, Integer pageSize, String keyWord) {
		...
		return gjfEnterpriseColumnService.findEnterpriseNewsList(pageNo, pageSize, keyWord);
	}
	...
	public ResultVo findEnterpriseNewsListsById(Long id) {
		...
		return gjfEnterpriseColumnService.findEnterpriseNewsListsById(id);
	}
